...
class DataLogging(object):
    """Utility class for recording simulation statistics over time."""
    ...
    def update_data(
        ...
        """Append the latest fleet statistics to internal lists."""
        ...
        self.n_cars_driving_without_passenger.append(
            n_cars_driving_without_passenger
        )
        self.n_cars_driving_with_passenger.append(
            n_cars_driving_with_passenger
        )
